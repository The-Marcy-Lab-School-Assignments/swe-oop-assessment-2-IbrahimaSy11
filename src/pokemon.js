class Pokemon {
  ...
  /*
        I can’t access the private field (health) directly, so I need to create a method
        to modify it inside the attack method

        create a method takeDamage
        paramter(amount)
        health -= amount

        now follow the question
  ...
  attack(targetPokemon) {
    targetPokemon.takeDamage(10 * this.#level);
